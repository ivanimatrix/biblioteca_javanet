...
public class GuardarPrestamo extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int numero_prestamo = Integer.parseInt(request.getParameter("id_prestamo"));
        ...
        PrestamoDTO prestamo = new PrestamoDTO(numero_prestamo, fecha_entrega, id_alumno, id_libro, estado_entrega);
        ...
        try{
            if(prestamoDAO.insert(prestamo) > 0){
                estado = true;
                mensaje = "Préstamo registrado con código nº " + numero_prestamo;
            }else{
                mensaje = "Préstamo no registrado. Intente nuevamente";
            }
